...
It is evident once again that some challenges remain. Particularly with regard to spelling. The oft confusing British vs American spelling quagmire. Case in point "fuellingkenya" vs "fuelingkenya". One may use regular expressions to try and solve this problem but that often leads to other complications.
```{r eval=FALSE}
<img src="https://imgs.xkcd.com/comics/perl_problems.png"><br>
```
...
To have a look into how followers are distributed amongst the three largest oil marketers I plot a Venn diagram. From the Venn diagram one can see that Total Kenya has the largest number of followers eclipsing the other two large oil marketers. I hypothesize that the large lead over Vivo Energy that Total Kenya has is attributable to the relatively late entry of Vivo Evergy into the downstream oil and gas business after taking over operations of Royal Dutch Shell. A better metric to compare the oil marketers would be the rate of growth in followers over time. However, data constraints prevent this.  
All three oil marketers share 788 followers with Vivo Energy and Total Kenya sharing a relatively large number of followers at 2827. Vivo Energy and KenolKobil have a relatively small overlap of followers at 109.    
